import { r as registerInstance, c as createEvent, f as forceUpdate, h, g as getElement, H as Host } from './index-BbuAcMrL.js';
import { j as iconClose } from './index-v48bcPT9-B5HHaV0z.js';
...
const MenuTabs = ({ context }) => {
    ...
    return (h(Host, { slot: context instanceof MenuSettings ? 'ix-menu-settings' : 'ix-menu-about', class: {
        ...
        h("div", { class: context instanceof MenuSettings ? 'settings-header' : 'about-header' },
...
var ixMenuSettings_entry = /*#__PURE__*/Object.freeze({
    __proto__: null,
    ix_menu_settings: MenuSettings
});

export { MenuTabs as M, ixMenuSettings_entry as a, initialize as i, setTab as s };
//# sourceMappingURL=ix-menu-settings.entry-DnBYH2f-.js.map
