...
const MyDropdownMenu = class {
    ...
    render() {
        ...
        return (h("select", { key: 'c70b5678a1ccc96d50283f4d9fd39dfd2213a928', class: classOption }, Array.from({ length: optionsLength }).map((_, i) => (h("option", { value: this.valeOfEachOption[i] }, this.options[i])))));
    }
};
