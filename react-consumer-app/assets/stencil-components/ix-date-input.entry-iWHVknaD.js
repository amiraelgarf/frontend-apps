...
import { h as iconCalendar } from './index-v48bcPT9-B5HHaV0z.js';
import { D as DateTime } from './datetime-bDicGJUN-bDicGJUN.js';
import { d as dropdownController } from './dropdown-controller-D3K9vmFp-D3K9vmFp.js';
import { a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotEnd, c as SlotStart } from './input.util-DORL_qfP-BS3d3_oF.js';
import { c as createClassMutationObserver, H as HookValidationLifecycle } from './validation-CS0nhfz1-Vwiy-wt4.js';
import { m as makeRef } from './make-ref-bcj7UEIC-bcj7UEIC.js';
import './anime.es-Ou74PMQs-Ou74PMQs.js';
import './a11y-Bb7pDeaQ-Bb7pDeaQ.js';
import './mutation-observer-CX81WQtk-CX81WQtk.js';
import './rwd.util-pXYAoEyc-Dm9ErdFR.js';
...
const DateInput = class {
    ...
    render() {
        ...
        const invalidText = this.isInputInvalid
            ...
            : this.invalidText;
        return (h(Host, { key: '0e4cdaf4c02cbba3603c1d3dc75758fd1201408b', class: {
                disabled: this.disabled,
                readonly: this.readonly,
            } }, h("ix-field-wrapper", { key: '1e2fd924fa41c3f0eefcedd540b18ade0208f9ee', label: this.label, helperText: this.helperText, isInvalid: this.isInvalid, invalidText: invalidText, infoText: this.infoText, isInfo: this.isInfo, isWarning: this.isWarning, warningText: this.warningText, isValid: this.isValid, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, required: this.required, controlRef: this.inputElementRef }, this.renderInput()), h("ix-dropdown", { key: '0f28d9948148e58f7aa83f903f69a11d40ba99eb', "data-testid": "date-dropdown", trigger: this.inputElementRef.waitForCurrent(), ref: this.dropdownElementRef, closeBehavior: "outside", suppressOverflowBehavior: true, show: this.show, onShowChanged: (event) => {
                this.show = event.detail;
            } }, h("ix-date-picker", { key: '379a3474a3100fa8310ea21c221de2587d10eb13', ref: this.datepickerRef, format: this.format, locale: this.locale, range: false, from: (_a = this.from) !== null && _a !== void 0 ? _a : '', onDateChange: (event) => {
...
export { DateInput as ix_date_input };
//# sourceMappingURL=ix-date-input.entry-iWHVknaD.js.map
