...
import { c as iconMoreMenu, d as iconChevronDown } from './index-v48bcPT9-B5HHaV0z.js';
...
const CardList = class {
    ...
    render() {
        return (h(Host, { key: '9c7e330c5e56fdce20a528b8f6107833842e145c' }, h(CardListTitle, { key: 'e52c141d2a6947ce4d98adc5749370fe39700567', isCollapsed: this.collapse, label: this.label, showAllLabel: this.i18nShowAll, showAllCounter: this.showAllCount === undefined
                ? this.numberOfAllChildElements
                : this.showAllCount, onClick: () => this.onCardListVisibilityToggle(), onShowAllClick: (e) => this.onShowAllClick(e), hideShowAll: this.hideShowAll }), h("div", { key: 'ab0903170788ebba38b341959c21bedb125f4b33', class: {
                CardList__Overflow: true,
            }, style: this.computeMaskLayer() }, h("div", { key: 'bffa3e47652e170d19e788fabf2e4708f47b2a96', class: {
            ...
            }, onScroll: () => this.onCardListScroll() }, h("slot", { key: '3f96b3334bf6ff39797597f1318bf6a796d32503', onSlotchange: () => this.changeVisibilityOfSlotChildren() }), this.isShowMoreCardVisible() ? (h("ix-card", { class: {
...
//# sourceMappingURL=ix-card-list.entry-BacN4R1d.js.map
