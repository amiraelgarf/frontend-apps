...
const Pill = class {
    ...
    render() {
        ...
        return (h(Host, { key: '0b4354fb510044836e07dfcfd5b206cb31425f7c', style: this.variant === 'custom'
            ...
            } }, this.icon && (h("ix-icon", { key: 'dd45d19b124560abca8e13386e09475287e2a646', class: {
                'with-icon': true,
            }, name: this.icon, size: '16' })), h("span", { key: 'cbfda4bbaf4a0cbfba3c1b27b1626845f6365079', class: "slot-container" }, h("slot", { key: 'a186da99796d23caf3618f67370573a49102c420', onSlotchange: () => this.checkIfContentAvailable() }))), this.getTooltip()));
    }
...
//# sourceMappingURL=ix-pill.entry-mdBSdsv3.js.map
