...
import { a as anime } from './anime.es-Ou74PMQs-Ou74PMQs.js';
import { A as Animation } from './animation-Dp15M30K-Dp15M30K.js';
import { a as applicationLayoutService } from './service-Ca8OHh45-Bcz-b_u-.js';
import { m as matchBreakpoint } from './breakpoints-D6vSVaHq-D6vSVaHq.js';
import { j as iconClose, D as iconDoubleChevronUp, E as iconDoubleChevronDown, F as iconDoubleChevronRight, G as iconDoubleChevronLeft } from './index-v48bcPT9-B5HHaV0z.js';
import './typed-event-BdCnOrqW-BdCnOrqW.js';
...
const Pane = class {
    ...
    render() {
        return (h(Host, { key: 'ef23679a524b6ef0920ed74618700e39d332698d', class: {
            ...
            } }, h("aside", { key: '836145f46f598131cd0f7d48e1870b2b3fe56436', id: `pane-${this.composition}`, class: {
                'top-bottom-pane': this.isBottomTopPane && !this.isMobile,
                'left-right-pane': this.isLeftRightPane && !this.isMobile,
                'mobile-pane': this.isMobile,
                expanded: this.expanded,
            } }, h("div", { key: '5a74c72e36309bb8dd5c0ec4b34a61a97c6499c2', id: "title-div", class: {
            ...
            } }, h("ix-icon-button", { key: '58d5341a003c95577340aba395ad373cd47448e6', class: "title-icon", size: "24", icon: this.expanded
                ? this.isMobile || this.hideOnCollapse
                    ? iconClose
                    : this.expandIcon
                : this.minimizeIcon, ghost: true, onClick: () => this.dispatchExpandedChangedEvent(), "aria-controls": `pane-${this.composition}` }), h("span", { key: '50bc7296628c1f82932f4e59c6ff4438f7c911a3', class: {
                'title-text': true,
                rotate: !this.expanded && !this.isMobile && this.isLeftRightPane,
            } }, this.icon ? (h("ix-icon", { size: "24", name: this.icon })) : null, h("div", { key: '1d2017fad228bba526a69bb943ac139611e0fa9f', class: "title-text-overflow" }, h("ix-typography", { key: 'd92fabb3423abb36c474fc9342cb792dfcd1c162', format: "h4" }, this.heading)))), h("div", { key: 'ebc766b4b3010f6c0f93177e7fb71f002bbe0dfb', class: "side-pane-content", hidden: !this.showContent }, h("slot", { key: 'bbf3740942b66907306b07b97fc396b0eb98a50d' })))));
    }
...
export { Pane as ix_pane };
//# sourceMappingURL=ix-pane.entry-BnUYBgp6.js.map
