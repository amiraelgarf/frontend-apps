...
import { B as BaseButton } from './base-button-BfH8hAk6-DQuOGrGD.js';
import { n as iconSearch, m as iconClear } from './index-v48bcPT9-B5HHaV0z.js';
import { m as makeRef } from './make-ref-bcj7UEIC-bcj7UEIC.js';
import { a as addDisposableEventListener } from './disposable-event-listener-CKoABG1h-CKoABG1h.js';
import { b as a11yHostAttributes } from './a11y-Bb7pDeaQ-Bb7pDeaQ.js';
...
const CategoryFilter = class {
    ...
    render() {
        var _a, _b, _c;
        return (h(Host, { key: '42fc0940f51eeba50c75bcc9c611507f50dc959c' }, h("form", { key: 'c76012919eac411895e28fb0b2d1a93f9454bd7a', ref: (el) => (this.formElement = el) }, h("div", { key: 'db03e6f7d587cafc27f9ce1515f45d0155db5495', "read-only": this.readonly, class: {
                'input-container': true,
                disabled: this.disabled,
                focus: this.hasFocus,
                readonly: this.readonly,
                'no-icon': this.hideIcon,
            } }, h("ix-icon", { key: 'f46e872a458b3c3463c3ce285c344a84bbca886a', color: this.getIconColor(), class: { 'display-none': this.hideIcon }, name: (_a = this.icon) !== null && _a !== void 0 ? _a : iconSearch, size: "16" }), h("div", { key: 'a738622921a0c86715dfa9562774429ea977e2bd', class: "token-container" }, h("div", { key: '751bb10ea63772fbf52da2a30540068a1f45277f', class: "list-unstyled" }, this.filterTokens.map((value, index) => (h("span", { key: value.toString(), class: {
            ...
            } }, (_b = this.categories[this.category]) === null || _b === void 0 ? void 0 : _b.label)), h("input", Object.assign({ key: 'd1c2a357355789ec61ddf6aa39efeb16a2e77b92', class: {
                'text-input': true,
...
export { CategoryFilter as ix_category_filter };
//# sourceMappingURL=ix-category-filter.entry-C6IE8ZV4.js.map
