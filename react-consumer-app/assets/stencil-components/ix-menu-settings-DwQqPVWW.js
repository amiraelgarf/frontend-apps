import { r as registerInstance, c as createEvent, f as forceUpdate, h, g as getElement, H as Host } from './index-DcMv3VsE.js';
...
const MenuTabs = ({ context }) => {
    ...
    return (h(Host, { slot: context instanceof MenuSettings ? 'ix-menu-settings' : 'ix-menu-about', class: {
            show: context.show,
        } }, h("div", { class: context instanceof MenuSettings ? 'settings-header' : 'about-header' }, h("h2", { class: "text-h2" }, context.label), h("ix-icon-button", { ghost: true, size: "24", icon: iconClose, onClick: (e) => context.close.emit({
...
//# sourceMappingURL=ix-menu-settings-DwQqPVWW.js.map
