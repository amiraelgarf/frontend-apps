import { h } from './index-CALO0PMU.js';
...
const BaseButton = (props, children) => {
    ...
    return (h("button", Object.assign({}, ariaAttributes, { onClick: (e) => (props.onClick ? props.onClick(e) : undefined), tabindex: props.disabled ? -1 : ((_c = props.tabIndex) !== null && _c !== void 0 ? _c : 0), type: props.type, class: Object.assign(Object.assign({}, getButtonClasses(props.variant, props.outline, props.ghost, props.iconOnly, props.iconOval, props.selected, props.disabled || props.loading)), extraClasses) }), props.loading ? (h("ix-spinner", { size: getSpinnerSize(props), hideTrack: true })) : null, props.icon && !props.loading ? (h("ix-icon", { class: "icon", name: props.icon, size: props.iconSize, color: props.iconColor })) : null, h("div", { class: {
            content: true,
...
//# sourceMappingURL=base-button-Ch2hL2Ny.js.map
