...
const PieChart$1 = proxyCustomElement(class PieChart extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    render() {
        return (h(h.Fragment, null, h("svg", { key: 'a16a379a72dc03a1b9ff6584f95532f323c0560d', id: "pie-chart" }), h("div", { key: 'ed461e1b4503f8834a559840b114c3abb2daae52', class: "tooltip", style: { position: 'absolute' } })));
    }
...
function defineCustomElement$1() {
    ...
    const components = ["pie-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "pie-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, PieChart$1);
            }
            break;
    } });
}
...
const PieChart = PieChart$1;
const defineCustomElement = defineCustomElement$1;

export { PieChart, defineCustomElement };
