...
const MultiAxisChart$1 = proxyCustomElement(class MultiAxisChart extends H {
    ...
    render() {
        return (h("div", { key: 'cff662565b0b14a7caf31391ce2767ddddab6266', class: "chart-wrapper" }, h("div", { key: '1159094b70f266d2887d07962c91bea997f7a2ec', ref: (el) => (this.chartContainer = el) })));
    }
