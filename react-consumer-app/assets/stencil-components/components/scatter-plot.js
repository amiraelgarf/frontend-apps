...
import { o as ordinal, s as select } from './p-AkiUVwtn.js';
import { l as linear, m as max, a as axisBottom, b as axisLeft } from './p-DCeK6rus.js';
import { c as colors } from './p-CJG58WzC.js';
...
const ScatterPlot$1 = proxyCustomElement(class ScatterPlot extends H {
    constructor() {
        super();
        this.__registerHost();
    }
    ...
    render() {
        return (h("div", { key: 'a80ffbf7fb67774dfc9e55314919079125156d53', id: "scatter-plot-ID" }));
    }
    static get watchers() { return {
        "data": ["dataWatcher"]
    }; }
    static get style() { return scatterPlotCss; }
}, [0, "scatter-plot", {
        "data": [16],
        "myHight": [2, "my-hight"],
        "myWidth": [2, "my-width"],
        "nameOfSactter": [1, "name-of-sactter"],
        "colorOfPoint": [1, "color-of-point"],
        "xTitle": [1, "x-title"],
        "yTitle": [1, "y-title"],
        "xTicks": [2, "x-ticks"],
        "yTicks": [2, "y-ticks"]
...
function defineCustomElement$1() {
    ...
    const components = ["scatter-plot"];
    components.forEach(tagName => { switch (tagName) {
        case "scatter-plot":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, ScatterPlot$1);
            }
            break;
    } });
}
...
const ScatterPlot = ScatterPlot$1;
const defineCustomElement = defineCustomElement$1;

export { ScatterPlot, defineCustomElement };
