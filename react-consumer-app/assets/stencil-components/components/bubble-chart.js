...
const BubbleChart$1 = proxyCustomElement(class BubbleChart extends H {
    get el() { return this; }
    myHeight = 350;
    ...
    static get style() { return bubbleChartCss; }
}, [1, "bubble-chart", {
        "myHeight": [2, "my-height"],
        "myTitle": [1, "my-title"],
        "xTitle": [1, "x-title"],
        "yTitle": [1, "y-title"],
        "myWidth": [2, "my-width"],
        "bubbleData": [16, "bubble-data"],
        "charWidth": [32],
        "seriesData": [32],
        "countyName": [32]
    }, undefined, {
...
function defineCustomElement$1() {
    ...
    const components = ["bubble-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "bubble-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BubbleChart$1);
            }
            break;
    } });
}
...
const BubbleChart = BubbleChart$1;
const defineCustomElement = defineCustomElement$1;

export { BubbleChart, defineCustomElement };
