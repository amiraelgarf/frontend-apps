import { r as registerInstance, c as createEvent, h, H as Host, g as getElement } from './index-BbuAcMrL.js';
import { B as iconPlus, m as iconClear, k as iconChevronDownSmall } from './index-v48bcPT9-B5HHaV0z.js';
import { a as a11yBoolean } from './a11y-Bb7pDeaQ-Bb7pDeaQ.js';
import { A as ArrowFocusController } from './focus-BAKpVknt-Bx1qy6pB.js';
import { H as HookValidationLifecycle } from './validation-CS0nhfz1-Vwiy-wt4.js';
import { O as OnListener } from './listener-Cu2ljot5-D8xInyLe.js';
import { m as makeRef } from './make-ref-bcj7UEIC-bcj7UEIC.js';
import { c as createMutationObserver } from './mutation-observer-CX81WQtk-CX81WQtk.js';
import './disposable-event-listener-CKoABG1h-CKoABG1h.js';
...
const Select = class {
    ...
    render() {
        var _a, _b, _c, _d;
        return (h(Host, { key: '9c96e0484bd918417dcbfde85e300e81ee76ff14', "aria-disabled": a11yBoolean(this.disabled), class: {
                disabled: this.disabled,
            } }, h("ix-field-wrapper", { key: '2361bfc2f09908d32ee86ffea1ad3e03e0b0e35e', required: this.required, label: this.label, helperText: this.helperText, invalidText: this.invalidText, infoText: this.infoText, warningText: this.warningText, validText: this.validText, showTextAsTooltip: this.showTextAsTooltip, isInvalid: this.isInvalid, isValid: this.isValid, isInfo: this.isInfo, isWarning: this.isWarning, controlRef: this.inputRef }, h("div", { key: '3bc425f480a9709262a4a75d0efc3a0edd344208', class: {
                select: true,
                disabled: this.disabled,
            ...
            } }, h("div", { key: '36fb0119739e50e0b7ad33206b9ac2af13a2d02a', class: "input-container" }, h("div", { key: '69cd6098ab12694ccbb9f379fe306d20e058ab7d', class: "chips" }, this.isMultipleMode
            ...
            : '', h("div", { key: '10b6f384260f0137b92063c6277601b30d91e71e', class: "trigger" }, h("input", { key: '71222c3c2fce7115a28e1ddc798c1c947195b6c0', autocomplete: "off", "data-testid": "input", disabled: this.disabled, readOnly: this.readonly, required: this.required, type: "text", class: {
            ...
            (((_d = this.selectedLabels) === null || _d === void 0 ? void 0 : _d.length) || this.inputFilterText) ? (h("ix-icon-button", { key: "clear", class: "clear", icon: iconClear, ghost: true, oval: true, size: "16", onClick: (e) => {
                ...
                if (this.editable)
                    this.dropdownWrapperRef(ref);
            } }))))))), h("ix-dropdown", { key: 'aac8cbe6759915570b9f940a024a0c124b88d7cb', ref: (ref) => (this.dropdownElement = ref), show: this.dropdownShow, closeBehavior: this.isMultipleMode ? 'outside' : 'both', class: {
            ...
            } }, h("div", { key: '20c61f1e345f4203e0017480aecb16ba6559db53', class: {
                'select-list-header': true,
                hidden: this.hideListHeader || this.isDropdownEmpty,
            }, title: this.i18nSelectListHeader, onClick: (e) => e.preventDefault() }, this.i18nSelectListHeader), h("slot", { key: 'f16a3d974086f0ed7701b6b6ded216c7a3be1603', onSlotchange: () => {
                this.updateSelection();
            } }), h("div", { key: '6a1053c8bcd639b88a88ec1583514c1066e39677', ref: (ref) => (this.customItemsContainerElement = ref) }), this.isAddItemVisible() ? (h("ix-dropdown-item", { "data-testid": "add-item", icon: iconPlus, class: {
                'add-item': true,
...
//# sourceMappingURL=ix-select.entry-RaR8CeIW.js.map
