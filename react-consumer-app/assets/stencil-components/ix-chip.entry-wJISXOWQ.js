...
import { e as iconCloseSmall } from './index-v48bcPT9-B5HHaV0z.js';
...
const Chip = class {
    ...
    getCloseButton() {
        return (h("div", { class: "close-button-container" }, h("ix-icon-button", { type: "button", variant: "secondary", icon: iconCloseSmall, class: "close-button", oval: true, size: "16", style: this.variant === 'custom' ? { color: this.chipColor } : {}, ghost: true, onClick: (event) => {
    ...
    render() {
        ...
        return (h(Host, { key: '4d2b258d01d16b9345263141abe7d7d3388123c5', tabIndex: "-1", class: {
                ...
                icon: !!this.icon,
            } }, this.icon && (h("ix-icon", { key: '33e9f9070943d1ec93da391b0573cf0ca6f1fe01', class: {
                'with-icon': true,
            }, name: this.icon, size: '24', style: this.variant === 'custom'
                ? { color: this.outline ? this.background : this.chipColor }
                : undefined })), h("span", { key: '9d99f68cec5413c92f8077b9dc515e0fd152f5c5', class: "slot-container" }, h("slot", { key: '43d2e60889312f0b86a73781aa43abeba2064f12' })), isInactive === false && this.closable ? this.getCloseButton() : null), this.getTooltip()));
    }
    get hostElement() { return getElement(this); }
};
Chip.style = chipCss;

export { Chip as ix_chip };
//# sourceMappingURL=ix-chip.entry-wJISXOWQ.js.map
