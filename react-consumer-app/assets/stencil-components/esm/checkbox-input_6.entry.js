...
const DateInput = class {
    ...
    render() {
        return (h("div", { key: 'bb3d05ddc8dcc33817e99874decbcd3186b9a607', class: { 'date-wrapper': true, 'date-wrapper--disabled': this.disabled } }, h("label", { key: '558aaee45003b3f1bdbda4b2234d0815d735c125', htmlFor: this.name, class: "date-label" }, this.label), h("input", { key: '622eb891db31a7b4ee8295142e66fda0d2684494', type: "date", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, disabled: this.disabled, onChange: this.handleChange, class: "date-field", placeholder: "YYYY-MM-DD" })));
    }
};
