...
const UiNotification = class {
    ...
    content = '';
    render() {
        return (index.h(index.Host, { key: '2e444100700ad6dc8d014775992da2d8c7710972', class: `notification ${this.placement} ${this.type}` }, index.h("div", { key: '0f454a98d07147f52c3e1790e3200b1cd7ffd98a', class: "notification-box" }, this.header && index.h("div", { key: '9757e66758ac33de13356a01810d99fa44d006d1', class: "header" }, this.header), index.h("div", { key: '4c767a781550173099c792c51b44bc029ef69578', class: "content" }, this.content))));
    }
};
