...
var Tableau10 = colors.colors("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");
...
const PieChart = class {
    ...
    drawChart() {
        ...
        transform.select(svgEl).selectAll('*').remove();
        const svg = transform.select(svgEl)
            .attr('width', width)
            .attr('height', height)
            .append('g')
            .attr('transform', `translate(${width / 2}, ${height / 2})`);
        const color = transform.ordinal(Tableau10);
    ...
    render() {
        return (index.h(index.h.Fragment, null, index.h("svg", { key: 'a16a379a72dc03a1b9ff6584f95532f323c0560d', id: "pie-chart" }), index.h("div", { key: 'ed461e1b4503f8834a559840b114c3abb2daae52', class: "tooltip", style: { position: 'absolute' } })));
    }
};
PieChart.style = pieChartCss;

exports.pie_chart = PieChart;
//# sourceMappingURL=pie-chart.entry.cjs.js.map

//# sourceMappingURL=pie-chart.cjs.entry.js.map