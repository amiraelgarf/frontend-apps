...
const BubbleChart = class {
    ...
    drawOrUpdateChart() {
        ...
        if (!this.apexChartInstance) {
            this.apexChartInstance = new apexcharts_esm.us(chartContainer, newOptions);
    ...
    render() {
        return (index.h("div", { key: '8bda5bc282c503bfd89c93e93a1039cbd5155981', id: "chartBubble" }));
    }
...
exports.bubble_chart = BubbleChart;
//# sourceMappingURL=bubble-chart.entry.cjs.js.map

//# sourceMappingURL=bubble-chart.cjs.entry.js.map