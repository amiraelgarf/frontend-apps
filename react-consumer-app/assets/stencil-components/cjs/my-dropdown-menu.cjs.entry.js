...
const MyDropdownMenu = class {
    ...
    render() {
        ...
        return (index.h("select", { key: '3427cbe1c36b1603d5f1eb54e95c971915312ce3', class: classOption }, Array.from({ length: optionsLength }).map((_, i) => (index.h("option", { value: this.valeOfEachOption[i] }, this.options[i])))));
    }
};
