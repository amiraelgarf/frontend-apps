...
const MultiAxisChart = class {
    ...
    initializeChart() {
        if (this.chartContainer && this.categories && this.series && this.yAxes) {
            if (!this.chart) {
                this.chart = new apexcharts_esm.us(this.chartContainer, this.buildApexOptions());
                this.chart.render();
            }
        }
    }
    ...
    render() {
        return (index.h("div", { key: 'cff662565b0b14a7caf31391ce2767ddddab6266', class: "chart-wrapper" }, index.h("div", { key: '1159094b70f266d2887d07962c91bea997f7a2ec', ref: (el) => (this.chartContainer = el) })));
    }
};
MultiAxisChart.style = multiAxisChartCss;

exports.multi_axis_chart = MultiAxisChart;
//# sourceMappingURL=multi-axis-chart.entry.cjs.js.map

//# sourceMappingURL=multi-axis-chart.cjs.entry.js.map