...
const MyTextField = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '470e8022c5477b50f07a036853d271c07b37f323' }, index.h("form", { key: '79dba9995aca454c6d1a2d2fe2afab73611273d5' }, index.h("label", { key: '948ef446e84d32c10374332c2465b86024806c68', htmlFor: "TextField", id: "labelText", style: { color: this.ColorOfLable } }, this.lablelText), index.h("input", { key: '148b52fed5896235669084b7c412262b8ed99878', type: "text", placeholder: this.textInPlaceholder, id: "TextField", class: classesInput, required: this.IsRequeredToFill, size: this.size, disabled: this.disable }))));
    }
};
MyTextField.style = myTextFieldCss;

exports.my_text_field = MyTextField;
//# sourceMappingURL=my-text-field.entry.cjs.js.map

//# sourceMappingURL=my-text-field.cjs.entry.js.map