...
const MyDropdownMenu = class {
    ...
    render() {
        ...
        return (h("select", { key: '8a905f6286bdab5e1c9e2112f91525552e02bb3f', class: classOption }, this.options.map((op, index) => h("option", { value: this.valeOfeachOption[index] }, op))));
    }
};
