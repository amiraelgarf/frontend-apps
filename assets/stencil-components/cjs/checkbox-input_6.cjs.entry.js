...
const CheckboxInput = class {
    ...
    render() {
        return (index.h("label", { key: 'ccd6c2e3e5ee64f6f3cb175a8e5ee3aed474d8a0', class: { 'checkbox-wrapper': true, 'checkbox-wrapper--disabled': this.disabled } }, index.h("input", { key: 'b426a0524fdfd87c9f46cc20b1ccd4342a091009', type: "checkbox", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, onChange: this.handleChange, class: "checkbox-input" }), index.h("span", { key: '1f5724ce34ad9406f4a5150cd34d2111afdd9479', class: "checkbox-custom" }, index.h("svg", { key: 'e1b4d16a4d2e1a757e86863e600a7aa8f68909df', class: "checkbox-checkmark", viewBox: "0 0 24 24" }, index.h("polyline", { key: 'ada4b6aee32b51942ba22e087a982e6da06063e1', points: "20 6 9 17 4 12" }))), index.h("span", { key: '09f7e911d72e25ee7254d72033eea93b51072fb0', class: "checkbox-label" }, this.label)));
    }
};
...
const DateInput = class {
    ...
    render() {
        return (index.h("div", { key: 'aa04ff7d407fd84791c431c0a3a19c1f9987456f', class: { 'date-wrapper': true, 'date-wrapper--disabled': this.disabled } }, index.h("label", { key: 'baf93028fdae0cdc0f4513b88b5a1eac00cf5351', htmlFor: this.name, class: "date-label" }, this.label), index.h("input", { key: '922b5d7975ee0374820aa89a0eaf5ed3e377057c', type: "date", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, disabled: this.disabled, onChange: this.handleChange, class: "date-field", placeholder: "YYYY-MM-DD" })));
    }
};
...
const MyButton = class {
    ...
    render() {
        ...
        return (index.h("button", { key: 'd983e232e8f57aac23c2fc237ebb93cbb7ca374c', class: classes, disabled: this.disabled, onClick: this.handleClick, type: "button" }, this.label));
    }
};
...
const RadioButton = class {
    ...
    render() {
        return (index.h("label", { key: 'b952bc415bca608c091647c94c2b3702ef7aae42', class: { 'radio-button-wrapper': true, 'radio-button-wrapper--disabled': this.disabled } }, index.h("input", { key: '51878a2909620bd899a403f3fe028df1b918e00b', type: "radio", name: this.name, value: this.value, checked: this.checked, disabled: this.disabled, onChange: this.handleChange, class: "radio-button-input" }), index.h("span", { key: '283afb1070d2b9893cf74644b0d9664698f7d798', class: "radio-button-custom" }), index.h("span", { key: '55d437a4ac235bc5f0d7b7b08e256b2cc85950cd', class: "radio-button-label" }, this.label)));
    }
};
...
const RangeInput = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '3c18df2a3b0b8deb6c197dcf104669f5c39fb257', class: { 'range-wrapper': true, 'range-wrapper--disabled': this.disabled }, style: { '--fill-percentage': `${fillPercentage}%` } }, index.h("label", { key: '0167ada083de278b18b1c862d30597546a1b4ec3', htmlFor: this.name, class: "range-label" }, this.label, index.h("span", { key: '62054d1b39027e161fff7122a3ade0d512a2d2f0', class: "range-value" }, this.value)), index.h("input", { key: '778585b244b94edaadbdf472d849ec444608b198', type: "range", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, step: this.step, disabled: this.disabled, onChange: this.handleChange, class: "range-field" })));
    }
};
...
const TimeInput = class {
    ...
    render() {
        return (index.h("div", { key: '772d5b3e771282d11f758397ff8e844bf3a82caf', class: { 'time-wrapper': true, 'time-wrapper--disabled': this.disabled } }, index.h("label", { key: '2dcbf41c28709bc5416ab08b8e4069919c45dec9', htmlFor: this.name, class: "time-label" }, this.label), index.h("input", { key: '02ca065ac5a6d10b6d6b0d6c62ac95b6ef3c09b2', type: "time", id: this.name, name: this.name, value: this.value, min: this.min, max: this.max, step: this.step, disabled: this.disabled, onChange: this.handleChange, class: "time-field", placeholder: "HH:MM" })));
    }
};
