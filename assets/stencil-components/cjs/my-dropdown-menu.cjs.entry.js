...
const MyDropdownMenu = class {
    ...
    render() {
        ...
        return (index.h("select", { key: 'f0d86a3e7ae5751220798b96ec6951c341951812', class: classOption }, Array.from({ length: optionsLength }).map((_, i) => (index.h("option", { value: this.valeOfEachOption[i] }, this.options[i])))));
    }
};
MyDropdownMenu.style = myDropdownMenuCss;

exports.my_dropdown_menu = MyDropdownMenu;
//# sourceMappingURL=my-dropdown-menu.entry.cjs.js.map

//# sourceMappingURL=my-dropdown-menu.cjs.entry.js.map