...
const RightClickMenu = class {
    ...
    render() {
        return (index.h("div", { key: '693291faa28965738eec7378c14b0c8ea112967d', style: { height: '100vh', width: '100vw', overflow: 'hidden', position: 'relative' } }, this.menuVisible && (index.h("ul", { key: '15d26ff5ebad7e76ac67d6e539ffb91880364d12', ref: (el) => this.menuElementRef = el, class: "context-menu", style: {
