...
const MultiAxisChart = class {
    ...
    render() {
        return (index.h("div", { key: 'ae667fa43ee42e16b1d05a351dd3e5cdbe747078', class: "chart-wrapper" }, index.h("div", { key: '6cb9f525259d9421bae28aefaebfaa332b7fe312', ref: (el) => (this.chartContainer = el) })));
    }
};
