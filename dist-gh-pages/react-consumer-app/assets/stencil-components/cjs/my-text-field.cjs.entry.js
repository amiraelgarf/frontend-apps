...
const MyTextField = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0680b07f11882231e98ede125821dd7b84f4b304' }, index.h("form", { key: '8c53170b1c97412648a6f68a6bb1176cb52d06a0' }, index.h("label", { key: '04e0e4f6aff3621e6f0eca7ea582dc6940ca99c5', htmlFor: "TextField", id: "labelText", style: { color: this.ColorOfLable } }, this.lablelText), index.h("input", { key: '32bddfba7b78cef6a33b96871fc3e18bf3e7d708', type: "text", placeholder: this.textInPlaceholder, id: "TextField", class: classesInput, required: this.IsRequeredToFill, size: this.size, disabled: this.disable }))));
    }
};
